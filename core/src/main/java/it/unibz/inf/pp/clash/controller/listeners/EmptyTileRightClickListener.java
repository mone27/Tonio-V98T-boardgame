...
public class EmptyTileRightClickListener extends ClickListener {
    ...
    public EmptyTileRightClickListener(int rowIndex, int columnIndex, EventHandler eventHandler) {
