...
public class Boardprova implements Board {
    ...
    public Boardprova(Unit[][] grid) {
        this.grid = grid;
    }

    @Override
    public int getMaxColumnIndex() { return grid[0].length - 1;
       }


       @Override
    public int getMaxRowIndex() {  return grid.length - 1;
    }
